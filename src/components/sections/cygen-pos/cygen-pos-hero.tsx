...
export default function CygenPOSHero() {
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
          ...
          >
            <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 leading-tight mb-6">
              ...
              Smarter with
              <br />
              <span className="text-blue-600">CYGEN POS</span>
            </h1>

            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              POS built for speed, simplicity, and scalability — Whether you're running a busy café, a fine-dine
              restaurant, or a retail store, CYGEN POS gives you the tools to succeed.
            </p>
