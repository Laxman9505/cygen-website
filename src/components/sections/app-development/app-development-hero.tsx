  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-9xl mx-auto">
          <div
          ...
          >
            <h1 className="w-full text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 leading-tight mb-6">
          ...
          >
            <div className="relative max-w-lg mx-auto">
              ...
              <div
                className={`absolute -top-4 -right-4 w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center transition-all duration-1000 delay-1000 ${
                  isVisible
              ...
              <div
                className={`absolute -bottom-6 -left-6 w-20 h-20 bg-teal-100 rounded-full flex items-center justify-center transition-all duration-1000 delay-1200 ${
                  isVisible
                    ? "opacity-100 translate-y-0 animate-float"
                    : "opacity-0 translate-y-4"
                }`}
              ...
              <div
                className={`absolute top-1/2 -left-8 w-12 h-12 bg-orange-100 rounded-full flex items-center justify-center transition-all duration-1000 delay-900 ${
                  isVisible
