...
export default function CygenOnlineOrderingHero() {
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
          ...
          >
            ...
            Empower Your Business 
              ...
              with Branded
              <br />
              <span className="text-blue-600">Online Ordering</span>
            </h1>

            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
            Launch your own direct ordering platform for pickup, delivery, or in-store collection — fully branded, commission-free, and designed for both hospitality and retail success.
            </p>
