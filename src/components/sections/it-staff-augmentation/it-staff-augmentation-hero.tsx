...
export function ITStaffAugmentationHero() {
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
          ...
          >
            <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 leading-tight mb-6">
              IT Staff <span className="text-blue-600">Augmentation</span>{" "}
              Services
            </h1>

            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Since 2007, CYGEN has helped businesses scale efficiently with
              top-tier IT professionals. Our tailored IT staff augmentation
              services bridge talent gaps and boost your team's productivity
